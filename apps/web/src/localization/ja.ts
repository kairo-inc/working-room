...
export default {
  ...
  accessGroup: {
    ...
    chatDirNotAllowed: "チャットフォルダはアクセスグループに追加できません",
    privateDirNotAllowed: "プライベートフォルダはアクセスグループに追加できません",
  ...
  file: {
    ...
    errors: {
      ...
      cannotDeleteRoot: "ルートフォルダは削除できません。",
      cannotDeletePrivate: "プライベートフォルダは削除できません。",
      cannotDeleteChat: "チャットフォルダは削除できません。",
      cannotDeleteShared: "共有ルートフォルダは削除できません。",
      createDirectoryFailed: "フォルダの作成に失敗しました。",
      createDirectoryPermissionDenied: "この場所にフォルダを作成する権限がありません。",
      renameFailed: "ファイル名の変更に失敗しました。",
      renamePermissionDenied: "このファイルの名前を変更する権限がありません。",
      copyFailed: "ファイルのコピーに失敗しました。",
      cannotCopyDirectory: "フォルダはコピーできません。",
      ...
      updateContentFailed: "ファイルの保存に失敗しました。",
      updateContentPermissionDenied: "このファイルを編集する権限がありません。",
      ...
      cannotMoveIntoDescendant: "フォルダをその子孫に移動することはできません。",
      cannotMoveIntoFile: "ファイルまたはフォルダをファイルに移動することはできません。",
      cannotMoveChat: "チャットフォルダは移動できません。",
    },
  },
  modal: {
    userEdit: {
    ...
    directoryCreate: {
      title: "フォルダ作成",
      directoryName: "フォルダ名",
      directoryNamePlaceholder: "フォルダ名を入力",
      create: "作成",
      failed: "失敗",
    },
    fileCreate: {
      title: "新しいファイル",
      fileName: "ファイル名",
      fileNamePlaceholder: "例: notes.md",
      fileType: "ファイル種別",
    ...
    directoryDelete: {
      title: "フォルダ削除",
      confirm: "このフォルダを削除してもよろしいですか？",
      allFilesDeleted: "このフォルダ内のすべてのファイルも削除されます。",
      failed: "失敗",
    },
    fileRename: {
      title: "ファイル名変更",
