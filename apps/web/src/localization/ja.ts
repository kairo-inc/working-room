...
export default {
  ...
  accessGroup: {
    ...
    chatFolderNotAllowed: "チャットフォルダはアクセスグループに追加できません",
    privateFolderNotAllowed: "プライベートフォルダはアクセスグループに追加できません",
