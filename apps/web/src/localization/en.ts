export default {
  ...
  accessGroup: {
    ...
    chatFolderNotAllowed: "Chat folders cannot be added to access groups",
    privateFolderNotAllowed: "Private folders cannot be added to access groups",
  ...
  file: {
    ...
    errors: {
      ...
      createFolderPermissionDenied: "You do not have permission to create a folder in this location.",
      ...
      cannotCopyFolder: "You cannot copy a folder.",
