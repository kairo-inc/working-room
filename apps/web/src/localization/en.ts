export default {
  ...
  accessGroup: {
    ...
    chatDirNotAllowed: "Chat folders cannot be added to access groups",
    privateDirNotAllowed: "Private folders cannot be added to access groups",
  ...
  file: {
    ...
    save: "Save",
    cancelEdit: "Cancel",
    backToDirectory: "Back to folder",
    ...
    errors: {
      ...
      cannotDeleteRoot: "You cannot delete the root folder.",
      cannotDeletePrivate: "You cannot delete private folders.",
      cannotDeleteChat: "You cannot delete chat folders.",
      cannotDeleteShared: "You cannot delete shared root folders.",
      createDirectoryFailed: "Failed to create folder.",
      createDirectoryPermissionDenied: "You do not have permission to create a folder in this location.",
      ...
      cannotCopyDirectory: "You cannot copy a folder.",
      ...
      cannotMoveIntoDescendant: "Cannot move a folder into its own descendant.",
      cannotMoveIntoFile: "Cannot move a file/folder into a file.",
      cannotMoveChat: "You cannot move a chat folder.",
    },
  },
  modal: {
    userEdit: {
    ...
    directoryCreate: {
      ...
      directoryNamePlaceholder: "Enter folder name",
      create: "Create",
      failed: "Failed",
    },
    fileCreate: {
    ...
    directoryDelete: {
      ...
      allFilesDeleted: "All files under this folder will also be deleted.",
      failed: "Failed",
    },
    fileRename: {
      title: "Rename File",
