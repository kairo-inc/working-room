import { PageSettingAccessGroupEdit, PageSettingAccessGroupEditProps } from "../../../../components/pages/setting/accessGroup/edit"
...
export default function AccessGroup(props: PageSettingAccessGroupEditProps) {
  return (
    <>
      <title>Access Group Edit</title>
      <PageSettingAccessGroupEdit {...props} />
    </>
  )
}

export const getServerSideProps = handleSsr<PageSettingAccessGroupEditProps>({
